...
const ChatDetail = () => {
    ...
    const { data: historyMessages, isLoading, isSuccess, isFetching } = useGetMessagesQuery(chatId);
    ...
    if (isLoading || isFetching) return <Typography>Loading messages...</Typography>;
    if (!currentUser) return <Typography color="error">يرجى تسجيل الدخول.</Typography>;
                    ...
                    >
                        <Typography 
                            ...
                            sx={{ 
                                ...
                                borderRadius: '10px',
                                maxWidth: '70%',
                                backgroundColor: msg.sender._id === currentUser._id ? '#1976d2' : '#e0e0e0',
