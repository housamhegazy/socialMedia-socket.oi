...
import { GroupAdd, Done, Close, Person } from '@mui/icons-material';
import { 
...
const FriendRequestsDropdown = () => {
    ...
    return (
        <Box sx={{ ml: 2, display: 'flex', alignItems: 'center' }}>
            ...
            >
                <Typography variant="h6" sx={{ p: 2, fontWeight: 700, color: 'primary.main', textAlign: 'right' }}>
                    طلبات صداقة جديدة ({requestsCount})
                </Typography>
                <Divider />
                ...
                {pendingRequests.map((request) => (
                    ...
                    >
                        ...
                        <Button
                            ...
                            startIcon={isAccepting ? <CircularProgress size={16} color="inherit" /> : <Done />}
                        >
                            قبول
                        </Button>
